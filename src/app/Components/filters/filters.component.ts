...
import { incomesCategory } from '../../Interface/Transaction';
@Component({
...
export class FiltersComponent {
  ...
  @Output() selectedCategoryChange = new EventEmitter<incomesCategory>();
  ...
  categorySelected: incomesCategory = 'all';
  selectedDate: string = '';
  ...
  emitByCategory(event: incomesCategory) {
